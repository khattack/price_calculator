...
start_price = st.number_input("Start Price", value=0.5500, step=1e-6, format="%.6f")
end_time = st.text_input("End Date and Time (YYYY-MM-DD HH:MM)", "2024-02-13 03:41")
end_price = st.number_input("End Price", value=0.6225, step=1e-6, format="%.6f")
...
st.write(f"Predicted price at {target_time}: **{predicted_price:.8f}**")
